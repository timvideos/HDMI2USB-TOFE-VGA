...
xst -ifn xst.scr
move sdsd_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\sdsd_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc sdsd_exdes.ucf sdsd_exdes

echo 'Running map'
map -timing -pr b sdsd_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm sdsd_exdes -w routed.ncd routed.vhd
cd ..
